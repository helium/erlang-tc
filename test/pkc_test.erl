...
basic_test() ->
    ...
    AliceSK = secret_key:random(),
    AlicePK = secret_key:public_key(AliceSK),
    BobSK = secret_key:random(),
    BobPK = secret_key:public_key(BobSK),
    ...
    Decrypted = secret_key:decrypt(AliceSK, Cipher),
